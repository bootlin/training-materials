...
Before:
\begin{center}
    \includegraphics[width=\textwidth]{slides/boot-time-init-scripts3/timechart-initramfs.pdf}
\end{center}
After:
\begin{center}
    \includegraphics[width=\textwidth]{slides/boot-time-kernel/timechart-modules.pdf}
\end{center}
\end{frame}
...
Before (gzip):
\begin{center}
    \includegraphics[height=0.2\textheight]{slides/boot-time-kernel/timechart-modules.pdf}
\end{center}
After (LZO):
\begin{center}
    \includegraphics[height=0.2\textheight]{slides/boot-time-kernel/timechart-lzo.pdf}
\end{center}

...
\begin{frame}{Buildroot: introduction}
  \begin{columns}
    ...
    \item Active community, releases published every 3 months. One LTS
      release made every 2 years, maintained for 3 years.
    \end{itemize}
  \end{columns}
\end{frame}
...
\begin{frame}{Public layers (1/2)}
  ...
  \item Core layers
    ...
    \item \href{https://git.yoctoproject.org/meta-yocto/tree/meta-poky}{meta-poky}, a layer
      from the Yocto Project that defines the {\em Poky} distribution, a
      reference distribution. In practice not useful for real projects.
    \item

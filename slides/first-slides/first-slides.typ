...
#titleframe()
#let sessionurl = if "sessionurl" in sys.inputs{
  sys.inputs.sessionurl
}else{none}
...
// If the materials a generated for a real session, not for the website
  ...
  [
    === Electronic copies of these documents
        - Electronic copies of your particular version of the materials are available on: #sessionurl

...
\begin{frame}[fragile]
  ...
  \item The allocated area maps to physically contiguous pages, in the
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
  \item \kconfig{CONFIG_SLUB}: the default allocator, a good generic
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
  \item The \kfunc{vmalloc} allocator is used to obtain memory zones

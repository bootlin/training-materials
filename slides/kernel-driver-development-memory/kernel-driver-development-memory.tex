...
\begin{frame}
  ...
  \begin{itemize}
     \item Virtual memory and Linux, Alan Ott and Matt Porter, 2016\\
	Great and much more complete presentation about this topic\\
	\url{http://bit.ly/2Af1G2i} (video: \url{http://bit.ly/2Bwwv0C})
  \end{itemize}
  \begin{center}
     \includegraphics[width=0.75\textwidth]{slides/kernel-driver-development-memory/ott-porter-kernel-virtual-memory-presentation.jpg}
  \end{center}
\end{frame}

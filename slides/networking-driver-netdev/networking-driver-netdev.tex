...
\begin{frame}{Receiving data}
	\begin{itemize}
		...
		\item Most of the processing occurs in \textbf{softirq} context, on the \textbf{same CPU} that handles the interrupt
	\end{itemize}
\end{frame}
...
\begin{frame}{Flow steering}
	\begin{itemize}
		\item Advance controllers have the ability to \textbf{parse} packet headers

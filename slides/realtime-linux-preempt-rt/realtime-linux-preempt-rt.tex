...
\begin{frame}
  \frametitle{Locking inside the Linux Kernel}
	\begin{itemize}
...
\begin{frame}
  \frametitle{Sleeping locks}
	...
	\end{itemize}
	\item Can't be used in \textbf{NMI}, \textbf{hardirq} and \textbf{softirq} contexts
	\end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{Spinlocks}
	\begin{itemize}
		...
		\end{itemize}
		\item Spinlocks will \textbf{disable preemption} when taken
		\item They can be used in \textbf{any} context, but with precaution

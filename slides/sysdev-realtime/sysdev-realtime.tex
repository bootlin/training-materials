...
\begin{frame}
  ...
  \column{0.6\textwidth}
  \begin{itemize}
  \item Bootlin's new course:\\
        {\em Real-time Linux with PREEMPT\_RT}\\
	\url{https://bootlin.com/training/preempt-rt/}\\
        Freely available slides and lab instructions.
  ...
  \end{itemize}
  \column{0.4\textwidth}
    \includegraphics[width=\textwidth]{slides/sysdev-realtime/preempt-rt-cover.png}\\
    \vspace{0.5cm}
    \tiny Bootlin's new {\em Real-time Linux with PREEMPT\_RT} training course.
  \end{columns}
\end{frame}

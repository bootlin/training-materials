...
\begin{frame}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[width=0.9\textwidth]{slides/sysdev-realtime/spinlock-deadlock-with-interrupt.pdf}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[height=0.65\textheight]{slides/sysdev-realtime/priority-inversion.pdf}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.9\textwidth]{slides/sysdev-realtime/spinlock-deadlock-with-preemption.pdf}
  \end{center}

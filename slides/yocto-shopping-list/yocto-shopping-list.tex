...
\frametitle{Shopping list: hardware for this course}
  \begin{columns}
    ...
    \includegraphics[height=0.25\textheight]{slides/yocto-shopping-list/nunchuk.jpg} \\
    \vspace{1cm}
    \includegraphics[height=0.15\textheight]{slides/yocto-shopping-list/jumper-wires.jpg} \\
    \vspace{1cm}
    %% Source: https://commons.wikimedia.org/wiki/File:SD_card_icon.svg
    \includegraphics[height=0.15\textheight]{slides/yocto-shopping-list/sd-card.pdf}
  \end{columns}
\end{frame}

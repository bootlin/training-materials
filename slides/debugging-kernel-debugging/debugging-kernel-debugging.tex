...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item
        \code{kexec --type zImage -p my_zImage --dtb=my_dtb.dtb \ }
        \code{--initrd=my_initrd --command-line="kernel command line"}
    \end{itemize}
...
mount -t pstore pstore /sys/fs/pstore
  ...
  \end{block}
  \begin{itemize}
    \item If your data is not present in pstore filesystem, some services
      spawned early may have already collected/moved it 
        \begin{itemize}
          \item For example: systemd-pstore
        \end{itemize}
  \end{itemize}
\end{frame}

...
\begin{frame}[fragile]
  ...
  \begin{itemize}
  \item Care must be taken when accessing MMIO registers
    \begin{itemize}
    \item Memory mapped I/O can be weakly ordered
      \begin{itemize}
      \item Developer's responsibility to enforcing proper ordering
      \end{itemize}
    \item Endianness of the device may be different than the CPU endianness
      \begin{itemize}
      \item Endianness conversions might be required
      \end{itemize}

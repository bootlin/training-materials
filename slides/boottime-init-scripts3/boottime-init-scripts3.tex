...
Before:
\begin{center}
    \includegraphics[height=0.2\textheight]{slides/boottime-init-scripts/timechart-init.pdf}
\end{center}
After:
\begin{center}
    \includegraphics[height=0.2\textheight]{slides/boottime-init-scripts3/timechart-initramfs.pdf}
\end{center}
\begin{itemize}

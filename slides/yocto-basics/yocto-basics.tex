...
\begin{frame}
  \frametitle{The initial \code{build/} directory}
  \begin{itemize}
  \item The \code{oe-init-build-env} script creates the \code{build}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \end{itemize}
    \item The \code{oe-init-build-env} script lists some more example targets
  \end{itemize}
\end{frame}

\begin{frame}
  \frametitle{The \code{build/} directory after the build 1/2}
  \begin{description}[style=nextline]
...
\begin{frame}
  \frametitle{The \code{build/} directory after the build 2/2}
  \begin{description}

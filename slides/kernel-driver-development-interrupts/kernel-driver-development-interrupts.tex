...
\hline
\textbf{Mechanism} & \textbf{Context} & \textbf{Other} & \textbf{Priority} & \textbf{Can}   & \textbf{Typical} \\
                   &                  & \textbf{IRQs}  & \textbf{tuning}   & \textbf{sleep} & \textbf{Use} \\
\hline
Hard & Interrupt & Disabled    & No,  & No & Fast handling, \\
IRQ  &           & (local CPU) & FIFO &    & gen. purpose \\
\hline
...
\hline
Threaded & Process      & Enabled & Yes & Yes & Interrupt handling \\
IRQ      & (irq thread) &         &     &     & needing to block \\
\hline

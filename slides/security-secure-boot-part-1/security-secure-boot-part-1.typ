...
#table(
  ...
  [
    ...
    #align(center, [#image("phase1.svg", width: 90%)])
...
#table(
  ...
  [
    ...
    #align(center, [#image("phase2.svg", width: 85%)])
...
- Raspberry Pi Ltd has 2 whitepapers on the topic:
  ...
  - #link(
      "https://pip.raspberrypi.com/categories/1260-security/documents/RP-004651-WP/Raspberry-Pi-4-Boot-Security.svg",
    )[Boot security]

  - #link(
      "https://pip-assets.raspberrypi.com/categories/1260-security/documents/RP-003466-WP-3-Boot%20Security%20Howto.svg?disposition=inline",
    )[Secure Boot]
...
- HSM capability, API described in
  #link("https://www.nxp.com/docs/en/reference-manual/RM00284.svg")[RM00284]

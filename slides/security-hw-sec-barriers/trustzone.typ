  ...
  - They are also called *Trusted* / *Rich* Execution
    Environment (TEE/REE)
  ...
  - This is *orthogonal* to Exception Levels:
    ...
    - EL2, if it exists, can exist in *Secure*,
      *Non-Secure*, or both
  ...
  - The systems transitions from Non-Secure to Secure via exceptions,
    ...
    - asynchronous, via some _FIQ_ interrupts, depending on
      _SCR.FIQ_

    - synchronous, generated by an _smc_ (_secure monitor call_)
      instruction

  - _smc_ cannot be called from EL0, so userland would first need to
    issue a _svc_
  ...
  - Sounds familiar, why is it not simply the kernel?
    ...
    - usage: can you ensure attackers do not get _root_

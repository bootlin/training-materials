...
- #link(
    "https://developer.arm.com/documentation/100935/0100/The-TrustZone-hardware-architecture-?lang=en",
  )[TrustZone]
...
- TF-A is split into 5 steps:
  ...
  - BootLoader 3-2, or
    #link(
      "https://elixir.bootlin.com/arm-trusted-firmware/v2.14.0/source/bl32",
    )[BL32]
...
#align(center, [#image(
  "/common/armv8-boot-sequence-common-names.pdf",
  width: 60%,
)])
...
- There are different implementations of TEEs:
  ...
  - Qualcomm's
    #link(
      "https://docs.qualcomm.com/doc/80-88500-4/topic/78_Qualcomm_TEE_5_0.html",
    )[QTEE]
...
- Because REE FS TAs are loaded from the REE, the TEE needs to
  ...
  - the OP-TEE core embarks the public part of
    #text(size: 23pt)[#link(
      "https://elixir.bootlin.com/op-tee/4.9.0/source/keys/default_ta.pem",
    )[`default_ta.pem`]]
...
- Like all software, Secure World software can have bugs
  ...
  - #link(
      "https://www.keysight.com/blogs/en/authors/federico-menarini",

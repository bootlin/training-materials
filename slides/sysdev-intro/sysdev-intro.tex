...
\frametitle{Video systems}
  \begin{center}
    \includegraphics[width=0.9\textwidth]{slides/sysdev-intro/chromecast-2015.jpg}
  \end{center}
...
\frametitle{Point of sale terminal}
  \begin{center}
    \includegraphics[width=0.5\textwidth]{slides/sysdev-intro/point-of-sale.jpg}
  \end{center}
  \tiny
  Image credits: \url{https://bit.ly/2H8F9YR}
\end{frame}

\begin{frame}
\frametitle{Robots}
  \begin{center}
    \includegraphics[width=0.7\textwidth]{slides/sysdev-intro/beagle-robot.jpg}
  \end{center}
\end{frame}

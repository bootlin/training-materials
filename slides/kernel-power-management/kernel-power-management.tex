...
\begin{frame}
  ...
  \begin{itemize}
  \item The state of a device can change at runtime, a sort of
    per-device idle state
  ...
  \item New hooks may be added to the drivers:

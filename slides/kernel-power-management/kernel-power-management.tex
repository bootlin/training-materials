...
\begin{frame}
  ...
  \item Several power management \emph{building blocks}
    ...
    \item CPUidle (system wide)
    \item Frequency and voltage scaling (system wide)
    \item Suspend and resume (system wide)
    \item Runtime power management (peripheral specific)
    \item Power domains (SoC specific)
    \end{itemize}
...
\begin{frame}[fragile]
  ...
  \frametitle{Generic PM Domains (pmdomain, ex-genpd)}
  \begin{itemize}
  ...
  \item Driver example: \kfile{drivers/pmdomain/rockchip/pm-domains.c} \\
        See \kfuncbis{rockchip_pd_power_on}{_pd_power_on}, \kfuncbis{rockchip_pd_power_off}{_pd_power_off},
        \kfuncbis{rockchip_pm_add_one_domain}{_pm_add_one_domain}

...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \item There are also graphical tools to display perf data:
      \begin{itemize}
        \item
          \href{https://www.brendangregg.com/flamegraphs.html}{Flamegraphs}
          \begin{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item This tracer needs to be enabled with \kconfigval{CONFIG_IRQSOFF_TRACER}{y}.
    \begin{itemize}

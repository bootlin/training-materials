...
i2c0: i2c@01c2ac00 {
  ...
  \vspace{0.5cm}
  \code{#address-cells}: number of 32-bit values needed to encode the address fields\\
  \code{#size-cells}: number of 32-bit values needed to encode the size fields\\

  ...
  [
    ...
    - XDP programs may edit the received frame, and take a decision :
      ...
      - `XDP_ABORTED` : Similar `XDP_DROP` but triggers a
        #link(
          "https://elixir.bootlin.com/linux/v6.12.32/A/ident/xdp_exception",
        )[tracepoint]
...
#text(size: 15pt)[#link(
  "https://elixir.bootlin.com/linux/v6.12.32/source/tools/testing/selftests/bpf/progs/xdp_dummy.c",
)[example program]]
#v(-0.1em)
```c
SEC("xdp")
...
#v(0.5em)
#text(size: 15pt)[#link(
  "https://elixir.bootlin.com/linux/v6.15.1/source/tools/testing/selftests/bpf/progs/xdp_redirect_map.c",
...
#table(
  ...
  [
    ...
    - Also used to circumvent hardware issues
      ...
      - Wrong internal
        #link(
          "https://elixir.bootlin.com/linux/v6.15.1/source/drivers/net/ethernet/marvell/mvneta.c#L4424",
        )[interrupt routing]
...
+ #link(
    "https://lore.kernel.org/netdev/cover.1642758637.git.lorenzo@kernel.org/",
  )[XDP frags]

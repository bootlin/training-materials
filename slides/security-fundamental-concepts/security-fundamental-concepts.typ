...
#align(center, [#image("cryptographic-hash-function.svg", width: 80%)])
...
#align(center, [#image("symmetric_encrypt.svg", width: 80%)])
...
- Most symmetric encryption algorithms operate on blocks of a fixed size
  ...
  - When encrypting multiple blocks with the same key, some randomness
    ...
    #align(center, [
      #align(center)[
        #box(image("Tux.svg", width: 10%))#box(image(
...
- Modes ensuring data authentication:
  ...
  - CBC-MAC: Cipher block chaining message authentication code
    ...
    - CBC-MAC can be sent with the message, allowing receiver to verify
      data integrity
    #text(size: 11pt)[
      #align(center, [#image("CBC-MAC_structure.svg", width: 40%)
...
#align(center, [#image("asymmetric_encrypt.svg", width: 80%)])
...
#table(
  ...
  [
    ...
    #align(center, [#image("Diffie-Hellman_Key_Exchange.svg", width: 75%)
      #text(size: 16.5pt)[
...
#table(
  ...
  [
    ...
    #align(center, [#image("tls_empty.svg", width: 100%)])
...
#table(
  ...
  [
    ...
    #align(center, [#image("tls_client_hello.svg", width: 100%)])
...
#table(
  ...
  [
    ...
    #align(center, [#image("tls_server_finish.svg", width: 100%)])
...
#table(
  ...
  [
    ...
    #align(center, [#image("tls_client_finish.svg", width: 100%)])
...
#table(
  ...
  [
    ...
    #align(center, [#image("tls_full.svg", width: 100%)])

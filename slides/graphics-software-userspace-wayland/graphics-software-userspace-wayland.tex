...
\begin{frame}{Wayland overview and paradigm}
  ...
  \item Improves \textbf{security} aspects:
    ...
    \item Avoids running the compositor as root (using \code{systemd-logind} or \code{seatd})
    \end{itemize}
...
\begin{frame}{Wayland status and adoption}
  ...
  \item Wayland is now quite mature, robust, efficient and widely used
    ...
    \item Runs with user privileges with \code{systemd-logind} or \code{seatd}
    \end{itemize}
...
\begin{frame}[fragile]{Wayland debug and documentation}
  ...
  \item \textbf{Weston debugging}:
    \begin{itemize}
    \item Debug arguments: \code{--debug}, \code{--log=file.log}, \code{-l log,drm-backend}
  ...
  \item \textbf{Documentation} resources:
    ...
    \item Wayland book: \url{https://wayland-book.com}
    \item Wayland protocols: \url{https://wayland.app/protocols/}
    \end{itemize}
  \end{itemize}
\end{frame}

...
\begin{frame}
  ...
  \begin{itemize}
  \item Take the Eudyptula Challenge: \url{http://eudyptula-challenge.org/}\\
        A series of programming exercises for the Linux kernel of
        increasing complexity, up to getting patches accepted into the

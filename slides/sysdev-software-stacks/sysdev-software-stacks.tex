...
\begin{frame}{Example systemctl/journalctl commands}
  ...
  \item \code{systemctl status <something>.service}, status of one
    service
  \item \code{systemctl [start|stop] <something>.service}, start or stop a service
  \item \code{systemctl [enable|disable] <something>.service}, enable
  ...
  \item \code{journalctl _SYSTEMD_UNIT=<something>.service}, logs from

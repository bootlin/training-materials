...
Note: this training course will be replaced starting from September
2022 by an updated version of our {\em Embedded Linux system
  development} course, with details available at
\href{https://bootlin.com/training/embedded-linux-ng/}{bootlin.com/training/embedded-linux-ng/}.
...
{Lecture - Application development and debugging}
{
  ...
  \item Tracing and profiling solutions.
  \end{itemize}
}

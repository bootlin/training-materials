...
\arrayrulecolor{lightgray} {
  ...
  \begin{tabularx}{\textwidth}{|g|h|}
    ...
    Practical labs with the ARM based STM32MP157C-DK2 Discovery Board
...
{
  {\em Using the STM32MP157C-DK2 Discovery board}
  \begin{itemize}
...
{
  {\em On the STM32MP157C-DK2 Discovery board}
  \begin{itemize}

...
\arrayrulecolor{lightgray} {
  ...
  \begin{tabularx}{\textwidth}{|g|h|}
    ...
    Practical labs with the ARM based STM32MP157A-DK1 Discovery Board
...
{
  \begin{center}
    \includegraphics[height=5cm]{../slides/discovery-board/discovery-board.png}
  \end{center}
}
...
{
  {\em Using the STM32MP157A-DK1 Discovery board}
  \begin{itemize}
...
{
  {\em On the STM32MP157A-DK1 Discovery board}
  \begin{itemize}

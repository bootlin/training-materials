...
\feagendasummaryitem{Objectifs}{
  \begin{itemize}
  \item Apprendre les outils et techniques pour mesurer le temps de
    démarrage d'un système embarqué.
  \item Découvrir les techniques de réduction du temps de démarrage au
    niveau de l'initialisation de l'espace utilisateur Linux.
  \item Découvrir les techniques de réduction du temps de démarrage au
    niveau de l'initialisation du noyau Linux.
  \item Découvrir les techniques de réduction du temps de démarrage au
    niveau de l'initialisation du chargeur de démarrage.
  \item Apprendre d'autres techniques avancées et alternatives
    d'optimisation du temps de démarrage.
  \end{itemize}
}

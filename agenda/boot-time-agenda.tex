...
\feagendasummaryitem{Training objectives}{
  \begin{itemize}
  \item Learn the tools and techniques to measure the boot time of an
    embedded system.
  \item Discover the techniques to reduce the boot time spent during
    the {\em user-space} initialization
  \item Discover the techniques to reduce the boot time spent during
    the {\em kernel} initialization
  \item Discover the techniques to reduce the boot time spent during
    the {\em bootloader} initialization
  \item Learn about more advanced and alternative techniques for boot
    time optimization.
  \end{itemize}
}

...
\hypersetup{pdftitle={Formation - Comprendre les couches graphiques sous Linux},
  pdfauthor={Bootlin}}
...
\begin{center}
\LARGE
Formation - Comprendre les couches graphiques sous Linux\\
\large
...
\arrayrulecolor{lightgray} {
  ...
  \begin{tabularx}{\textwidth}{|g|h|}
    {\bf Titre} & {\bf Formation - Comprendre les couches graphiques sous Linux} \\
    \hline

...
\hypersetup{pdftitle={Formation - Comprendre la pile graphique sous Linux},
  pdfauthor={Bootlin}}
...
\begin{center}
\LARGE
Formation - Comprendre la pile graphique sous Linux\\
\large
...
\arrayrulecolor{lightgray} {
  ...
  \begin{tabularx}{\textwidth}{|g|h|}
    {\bf Titre} & {\bf Formation - Comprendre la pile graphique sous Linux} \\
    \hline

...
\def \trainers {alexis-lothore,luca-ceresoli,olivier-benjamin}
...
{
  \begin{itemize}
    \item eBPF concepts and tooling
    \item Using high-level eBPF frameworks and tooling
    \item Developping custom tooling with libbpf
  \end{itemize}
}
{eBPF pour l'analyse système}
{
  \begin{itemize}
    \item Concepts de base eBPF et outils associés
    \item Utilisation de frameworks eBPF "haut niveau"
    \item Developpement d'outils personnalisés basés sur eBPF
  \end{itemize}
}

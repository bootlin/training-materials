...
Note: cette formation sera remplacée à partir de septembre 2022 par
une version mise à jour de notre formation {\em Développement de
  systèmes Linux embarqué}, dont les détails sont disponibles sur
\href{https://bootlin.com/fr/formation/linux-embarque-ng/}{bootlin.com/fr/formation/linux-embarque-ng/}.
...
{Cours - Développement et déboguage d'application}
{
  ...
  \item Outils pour tracer et profiler des applications.
  \end{itemize}
}

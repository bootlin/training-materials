...
{NXP i.MX93 FRDM}
{
  {\bf NXP FRDM-IMX93} development board
  \begin{itemize}
    \item NXP i.MX93 SoC (Dual Cortex-A55 + Cortex-M33)
...
{NXP i.MX93 FRDM}
{
  Carte de développement {\bf NXP FRDM-IMX93}
  \begin{itemize}
    \item Processeur NXP i.MX93 (Dual Cortex-A55 + Cortex-M33)
    \item 2 GB LPDDR4X, 32 GB eMMC
    \item Double Ethernet Gigabit
    \item USB 2.0 Type-C + USB Type-A
    \item Interface CAN
    \item Slot microSD, EEPROM
    \item Wi-Fi 6 + Bluetooth 5.4 + 802.15.4 (MAYA-W276)
    \item Sortie HDMI (via LVDS), MIPI DSI et CSI
    \item Audio jack (MQS), buttons and LEDs
    \item debug via SWD et UART
  \end{itemize}
}
{
  \begin{center}
    \includegraphics[width=5cm]{slides/shopping-list-imx93-frdm/imx93-frdm.png}
  \end{center}
}

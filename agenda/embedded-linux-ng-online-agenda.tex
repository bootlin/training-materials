...
{
  {\bf STMicroelectronics STM32MP157D Discovery Kit~1} or {\bf STMicroelectronics STM32MP157A Discovery Kit~1} board
  \begin{itemize}
  \item STM32MP157(A/D), dual Cortex-A7 processor from STMicroelectronics
  \item USB powered

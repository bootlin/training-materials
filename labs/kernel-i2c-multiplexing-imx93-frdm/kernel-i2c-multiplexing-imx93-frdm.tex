...
\code{~/linux-kernel-imx93-frdm-labs/src/linux} directory.
...
By searching for \code{LPI2C4}, we find the
macros \code{MX93_PAD_GPIO_IO02__LPI2C4_SDA}
and \code{MX93_PAD_GPIO_IO03__LPI2C4_SCL}, which allow us to multiplex
the \code{GPIO_IO02} and \code{GPIO_IO03} pins as \code{LPI2C4_SDA}
and \code{LPI2C4_SCL}, respectively.
...
namely \code{0x40000B9E}. This register value implies that the pad control is
...
\includegraphics[width=0.7\textwidth]{common/imx93-frdm-connect-nunchuk.jpeg}

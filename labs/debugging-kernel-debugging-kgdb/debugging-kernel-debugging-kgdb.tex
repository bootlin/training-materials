...
Immediately after executing this commands, you'll see that the kernel will report
an OOPS!
...
\begin{bashinput}
(gdb) set arch %\kernelarch%
(gdb) set gnutarget %\ifdefstring{\arch}{ARM64}{elf64}{elf32}%-littlearm
\end{bashinput}
...
device for kgdboc is already set, or set it now:

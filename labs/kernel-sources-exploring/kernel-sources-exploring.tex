...
tree for the \code{imx93-frdm} board in \code{arch/arm64/boot/dts
freescale}, as it is not yet present in the Linux sources.
\begin{verbatim}
git apply ../data/0001-imx93-frdm.patch
\end{verbatim}
After that, modify the \code{Makefile} in the \code{freescale} directory to build the device tree for the \code{imx93-frdm} board.
\fi

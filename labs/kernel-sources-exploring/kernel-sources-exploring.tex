...
\item Find the Linux logo image in the sources\footnote{Look for
      files with \code{logo} in their name. It's an
...
grep}. It is similar to \code{grep} but ignores Git internal files and
generated files (as declared by \code{.gitignore}).

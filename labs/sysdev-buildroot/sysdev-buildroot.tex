...
Now checkout the tag corresponding to the latest 2026.02.<n> release (Long
...
\item \code{Toolchain}
  ...
  \item \code{External toolchain gcc version}: \code{15.x}
  \item \code{External toolchain kernel headers series}: Set it to match the
    version of the kernel headers chosen when building the toolchain.
...
\item \code{Kernel}
  ...
  \item Set \code{In-tree Device Tree Source file names} to
        \ifdefstring{\board}{stm32mp1}{\code{st/stm32mp157a-dk1-custom}}{}
        \ifdefstring{\board}{stm32mp2}{\code{st/stm32mp257f-dk-custom}}{}
        \ifdefstring{\board}{bbb}{\code{ti/omap/am335x-boneblack-custom}}{}
        \ifdefstring{\board}{beagleplay}{\code{ti/k3-am625-beagleplay-custom}}{}
	\ifdefstring{\board}{imx93-frdm}{\code{freescale/imx93-11x11-frdm-custom}}{}
\end{itemize}

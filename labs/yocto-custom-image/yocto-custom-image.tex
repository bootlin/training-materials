\subchapter{Lab 7: Create a custom image}{The highest level of customization in Poky}
...
Also, we will need to add a bit of free space on the root filesystem, so we can
later deploy extra applications. With \code{meta-st-stm32mp}, this can be done
with \code{IMAGE_ROOTFS_EXTRA_SPACE = "100 * 1000"}.
\fi

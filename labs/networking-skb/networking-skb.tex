...
\begin{enumerate}
	\item Save a copy of the original ethernet header, and remove it
...
We now need to reconstruct the Layer 2 header. Using the appropriate \code{skb} helper, re-increase the size of the \code{skb} by growing into the headroom the size of our blan header.

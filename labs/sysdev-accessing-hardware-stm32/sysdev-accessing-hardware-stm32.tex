...
\begin{itemize}
\item Connect one end to pin 7 of the {\em GPIO connector CN5}
...
you will see that the GPIO4/MCO1 pin on the board (pin 7 of connector CN5) is connected to the PF11
...
\if\defstring{\board}{stm32mp2}
In our case, we don't see such definitions, but they are actually
found in the \kfile{arch/arm64/boot/dts/st/stm32mp251.dtsi}
...
name for your system. Set the \code{model} property to \board media

...
\begin{hostbashinput}
$ cd $HOME/__SESSION_NAME__-labs/buildroot/overlay/root
$ mkdir xdp
$ cd xdp
\end{hostbashinput}
...
Move to the "Save" option, and hit "Quit" multiple times until you get out of the menuconfig interface.
...
receives frames from ALL ports. It distinguishes between the frames from each port

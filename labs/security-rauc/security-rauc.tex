...
$ cp ../../board_setup/build/tmp-glibc/deploy/images/freiheit93/security-training-image-freiheit93.rootfs.tar.gz rootfs.tar.gz
...
You might get SELinux errors during bundle installation: this can be fixed by
disabling SELinux in the kernel command line with \code{selinux=0}.

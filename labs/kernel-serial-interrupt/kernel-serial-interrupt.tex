...
To enable reception and its associated interrupt, the UART control register must be configured accordingly. This configuration is done within the \code{probe} function by setting the following bits:
\if\defstring{\board}{imx93-frdm}{
  \begin{verbatim}
  reg_write(serial, LPUART_CTRL_TE | LPUART_CTRL_RE | LPUART_CTRL_RIE, LPUART_CTRL);
  \end{verbatim}
\fi
...
reading the contents of the \ifdefstring{\board}{imx93-frdm}{\ksym{LPUART_DATA}}{}
\ifdefstring{\board}{stm32mp1}{\ksym{USART_RDR}}{}
\ifdefstring{\board}{bbb}{\ksym{UART_RX}}{}
\ifdefstring{\board}{beagleplay}{\ksym{UART_RX}}{} register, which holds the

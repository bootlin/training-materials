...
Notice that these templates do not include the signing configuration that
we saw in the examples of the lectures, so you'll have to add it.
...
If you successfully signed your AHAB containers, this is the output you should see when running \code{ahab_status}:

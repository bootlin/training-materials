...
\item For this specific board, the device tree is generated and then
  needs to be specified: \code{DTB_FILE_NAME=stm32mp257f-dk.dtb}
...
Now write the TF-A binary in the \code{fsbla1} partition:
...
by connecting the USB-C cable to the board, in CN21, \code{USB PWR STLINK} and

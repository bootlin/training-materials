...
\href{https://pypi.org/project/kas/}{pypi.org}
...
You might have to explicitly allow \code{bitbake} to use user namespaces:

First, add the following content in \code{/etc/apparmor.d/bitbake}:
...
\begin{bashinput}
sudo bmaptool copy build/tmp-glibc/deploy/images/freiheit93/security-training-image-freiheit93.rootfs.wic /dev/mmcblkX
\end{bashinput}

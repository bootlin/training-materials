...
imx93 SoC , available on
\url{https://www.nxp.com/webapp/Download?colCode=IMX93RM}. This document will
give us all the details abouts th SoC's features.

Secondly, download the Board Reference Manual for
the imx93 frdm, available on
\url{https://www.nxp.com/webapp/Download?colCode=UM12181}.
This document give information about the board's features and
connectors, and also about the pin assignments.

Theerdly, download board design files for the imx93 frdm, available on
\url{https://www.nxp.com/webapp/Download?colCode=FRDM-iMX93-DESIGN-FILES}.
These files contain the schematics about the board, which will be useful
to understand the board's features and connectors.

\section{Setting up serial communication with the board}

The imx93-frdm serial connector is the USB-C port labeled DEBUG on the side, next to the power USB-C port. You just need to connect the USB-C cable provided by your instructor to your PC.

...
% \ifthenelse{\equal{\labboard}{stm32mp1}}{\input{stm32-prepare.tex}}
% \ifthenelse{\equal{\labboard}{beagleplay}}{\input{beagleplay-prepare.tex}}
...
\ifdefstring{\labboard}{beagleplay}{\textbf{Warning: take care that if you also have

\subchapter{Experiment basic cryptographic tools}{Objective: Learn
...
We will also look at what happens when a certificate is revoked.
...
Try generating the certificate using the same CSR. What happens?
...
Also, you might see the encrypted message length is the same size as the key: with a key size
of 4096 bits, the encrypted message uses 512 bytes.

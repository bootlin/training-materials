...
Go to the \code{~/__SESSION_NAME__-labs/modules/nfsroot/root/debugging/}
directory.
...
and disassemble the corresponding \code{.o} file:

\if\defstring{\arch}{ARM32}{
\begin{verbatim}
...
exact assembly instruction where the crash occurred, together
...
the code of a module. Just disassemble the \code{.o} file

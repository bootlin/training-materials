\subchapter{Lab 4: Create a Yocto layer}{Add a custom layer to the Yocto project for
	your project needs}
...
\ifdefstring{\board}{bbb}{
  \def\bsplayername{meta-ti}
}{}

\ifdefstring{\board}{stm32mp1}{
  \def\bsplayername{meta-st-stm32}
}{}
...
\ifdefstring{\board}{imx93-frdm}{
  \def\bsplayername{meta-freescale}
}{}

To be fair, we already used and integrated a layer in our build
configuration during the first lab, with {\tt \bsplayername}. This
layer was responsible for \boarddescription{} support in Yocto. We
have to do the same for our \code{meta-bootlinlabs} now.

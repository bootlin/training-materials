...
during the first lab, with \bsplayername. This layer was responsible for
\boarddescription support in Yocto. We have to do the same for our \code{meta-bootlinlabs} now.

...
during the first lab, with \ifdefstring{\board}{stm32mp1}
{\code{meta-st-stm32}} {\code{meta-ti}}. This layer was responsible for \ifdefstring{\board}{stm32mp1} {\code{stm32mp1 DK1}}
{\ifdefstring{\board}{beagleplay} {\code{BeaglePlay}} {\code{BeagleBone Black}}} support in Yocto. We have to do the same for our

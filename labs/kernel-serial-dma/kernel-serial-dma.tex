...
Since the end of the DMA transfer does not imply the end of the processing for
the UART, it is best to also poll for the TX FIFO to be empty, pretty much like
we did in the helper writing the characters in \ksym{UART_TX} (polling for the
THRE bit to be set).

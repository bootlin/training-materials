...
\begin{bashinput}
sudo apt install bmaptool build-essential chrpath cpio debianutils diffstat efitools file \
...
Finally, there are build errors on \code{u-boot-imx}, as the
\code{cert-to-efi-sig-list} tool is not found. This is an issue with
meta-freescale, you can get around it using \code{HOSTTOOLS:append = "

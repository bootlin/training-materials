\subchapter{Lab 1: Building and Booting a Preempt-RT Kernel}{Download, Configure, Build and Boot}
...
\begin{bashinput}
cp $HOME/__SESSION_NAME__-labs/stm32mp157a_dk1_rt_defconfig configs
\end{bashinput}
...
full kernel preemption enabled, we have 2 main ways of checking.

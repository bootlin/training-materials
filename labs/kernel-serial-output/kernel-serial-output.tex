...
to our device specific private data structure (serial\_dev):
...
\begin{center}
\includegraphics[height=10cm]{labs/kernel-serial-output/link-structures-misc.pdf}
\end{center}

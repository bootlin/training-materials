...
\begin{center}
  ...
  \includegraphics[width=0.5\textwidth]{common/imx93-frdm-connect-nunchuk.jpg}
\end{center}
...
the kernel version is now \code{6.14.<x>-dirty}, the {\em dirty}
keyword indicating that the Git working tree has uncommitted changes.
The modules are therefore installed in \code{/lib/modules/6.14.<x>-dirty/},

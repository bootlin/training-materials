...
This machine describes a board using the \code{imx93} SoC and we take the board \code{imx93-evk} as a base. Add the following line to your machine configuration file:
\begin{verbatim}
...
UBOOT_DTB_NAME = "imx93-11x11-evk.dtb"

...
what we did in lab1, when we chose the \ifdefstring{\board}{stm32mp1}
{\code{stm32mp1}} {\ifdefstring{\board}{beagleplay}{\code{beagleplay}}{\code{beaglebone}}} one.
...
will make the
\ifdefstring{\board}{stm32mp1}{Discovery}{{\ifdefstring{\board}{beagleplay}{BeaglePlay}{BeagleBone}}}
properly boot.

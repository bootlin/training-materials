...
Don't forget to make the configuration aware of the meta-poky, ARM and TI
layers.
...
\begin{bashinput}
sudo bmaptool copy --removable-device $BUILDDIR/tmp/deploy/images/beaglebone/core-image-minimal-beaglebone.rootfs.wic.xz /dev/mmcblkX
\end{bashinput}
...
Once the USB to Serial connector is plugged in,
a new serial port should appear: \code{/dev/ttyUSB0}.
...
communication on \code{/dev/ttyUSB0}, with a baudrate of \code{115200}.

...
Because a beaglebone BSP is already provided by poky, we have to
remove its bsp layer to use the beaglebone machine from the
\code{meta-ti} layer. So remove the \code{poky/meta-yocto-bsp} layer
from the \code{BBLAYERS} variable.

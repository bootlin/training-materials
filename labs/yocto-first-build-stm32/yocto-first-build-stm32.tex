...
Go to the \code{$HOME/yocto-stm32-labs/} directory.
...
git checkout warrior-21.0.1 -b warrior-21.0.1
\end{verbatim}

Return to your project root directory (\code{cd $HOME/yocto-stm32-labs/})
and download the OpenEmbedded and STM32MP layers:
\begin{verbatim}
git clone git://git.openembedded.org/meta-openembedded
cd $HOME/yocto-stm32-labs/meta-openembedded
git checkout f4ccdf2bc3fe4f00778629088baab840c868e36b -b warrior
cd $HOME/yocto-stm32-labs/
git clone https://github.com/STMicroelectronics/meta-st-stm32mp.git
cd meta-st-stm32mp/
git checkout 8263d32304bfc4cc9a6848c50dcee2a9503dccd7 -b warrior
\end{verbatim}
...
Flash the SD card (\code{/dev/mmcblkX} in this example but it can be
\code{/dev/sdX} such as \code{/dev/sdc}) with that image:
\begin{verbatim}
umount /dev/mmcblk0*

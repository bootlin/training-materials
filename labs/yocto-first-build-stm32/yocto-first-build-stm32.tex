...
Ubuntu 26.04 added an apparmor policy preventing usage of unprivileged user
...
Then download the OpenEmbedded and STM32MP layers:
\begin{bashinput}
...
Don't forget to make the configuration aware of the meta-poky and STM32MP
layers.
...
and \code{meta-st-stm32mp}
directories to the \yoctovar{BBLAYERS} variable.
...
Once plugged in your computer,
a new serial port should appear: \code{/dev/ttyACM0}.
...
CN6, \code{PWR_IN} and to your PC at the other end.

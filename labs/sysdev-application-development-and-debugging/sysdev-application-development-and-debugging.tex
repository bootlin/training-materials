...
\begin{bashinput}
$ export PKG_CONFIG_PATH=$HOME/__SESSION_NAME__-labs/integration/buildroot/output/host/%\ifdefstring{\labboard}{beagleplay}{aarch64-}{arm-}%buildroot-linux-gnueabihf/sysroot/usr/lib/pkgconfig
$ %\ifdefstring{\labboard}{beagleplay}{aarch64-linux-gcc}{arm-linux-gcc}% -o nunchuk-mpd-client nunchuk-mpd-client.c \
...
\item \inlinebash{core.\%p > /proc/sys/kernel/core_pattern}, which will

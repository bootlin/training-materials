...
\begin{center}
\includegraphics[width=\textwidth]{labs/kernel-compiling-and-nfs-booting-bbb/host-vs-target.pdf}
\end{center}

\section{Setup}

Go to the \code{$HOME/linux-kernel-bbb-labs/src/linux} directory.
...
\begin{itemize}
  ...
  \item \kconfigval{CONFIG_AM335X_PHY_USB}{y} {\em Check its dependencies}
  \item \kconfigval{CONFIG_USB_ETH}{y}
\end{itemize}
...
(\kconfig{CONFIG_KERNEL_LZO}). You will need to install the \code{lzop}
...
\scriptsize
\begin{verbatim}
/home/<user>/linux-kernel-bbb-labs/modules/nfsroot 192.168.1.100(rw,no_root_squash,no_subtree_check)
\end{verbatim}
\normalsize
...
setenv bootargs root=/dev/nfs rw ip=192.168.1.100:::::usb0 console=ttyS0,115200n8
  ...
  nfsroot=192.168.1.1:/home/<user>/linux-kernel-bbb-labs/modules/nfsroot,nfsvers=3,tcp
\end{verbatim}

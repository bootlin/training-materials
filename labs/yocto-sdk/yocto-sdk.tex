...
\ifdefstring\labboard{beagleplay}{\code{deploy-ti/sdk}}{\code{tmp/deploy/sdk}}.
...
\begin{verbatim}
$BUILDDIR/deploy-ti/sdk/poky-glibc-x86_64-bootlinlabs-image-minimal-aarch64-bootlinlabs-toolchain-4.0.17.sh
\end{verbatim}
\fi
}

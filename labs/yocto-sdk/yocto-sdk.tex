...
\begin{verbatim}
$BUILDDIR/tmp/deploy/sdk/poky-glibc-x86_64-bootlinlabs-image-minimal-cortexa55-bootlinlabs-toolchain-5.0.2.sh
\end{verbatim}
\fi
}
...
an ELF \ifdefstring{\labboard}{beagleplay}{64}{\ifdefstring{\labboard}{imx93-frdm}{64}{32}}-bit LSB

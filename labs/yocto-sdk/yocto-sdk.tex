\subchapter{Lab 8: Develop your application in the Poky SDK}{Generate and use
the Poky SDK}
...
\begin{verbatim}
$BUILDDIR/tmp/deploy/sdk/poky-glibc-x86_64-bootlinlabs-image-minimal-cortexa8t2hf-neon-bootlinlabs-toolchain-6.0.2.sh
\end{verbatim}
\fi
\if\defstring{\board}{stm32mp1}
\begin{verbatim}
$BUILDDIR/tmp/deploy/sdk/poky-glibc-x86_64-bootlinlabs-image-minimal-cortexa7t2hf-neon-vfpv4-bootlinlabs-toolchain-6.0.2.sh
\end{verbatim}
\fi
\if\defstring{\board}{beagleplay}
\begin{verbatim}
$BUILDDIR/tmp/deploy/sdk/poky-glibc-x86_64-bootlinlabs-image-minimal-aarch64-bootlinlabs-toolchain-6.0.2.sh
\end{verbatim}
\fi
\if\defstring{\board}{imx93-frdm}
\begin{verbatim}
$BUILDDIR/tmp/deploy/sdk/poky-glibc-x86_64-bootlinlabs-image-minimal-cortexa55-bootlinlabs-toolchain-6.0.2.sh
\end{verbatim}
\fi
}
...
\if\defstring{\board}{imx93-frdm}
\begin{verbatim}
source environment-setup-cortexa55-poky-linux
\end{verbatim}
\fi
...
an ELF \ifdefstring{\arch}{ARM64}{64}{32}-bit LSB

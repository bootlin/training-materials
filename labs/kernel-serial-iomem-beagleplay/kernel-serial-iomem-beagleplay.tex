...
{\scriptsize \sourcecode{labs/kernel-serial-iomem-beagleplay/uarts-pinctrl.dts}}
...
\sourcecode{labs/kernel-serial-iomem-beagleplay/uarts.dts}
...
Go to the \code{~/linux-kernel-imx93-frdm-labs/modules/nfsroot/root/serial/}
directory. You will find a \code{serial.c} file which already provides a
...
\sourcecode{labs/kernel-serial-iomem-beagleplay/uart-line-init.c}
...
\sourcecode{labs/kernel-serial-iomem-beagleplay/uart-line-reset.c}

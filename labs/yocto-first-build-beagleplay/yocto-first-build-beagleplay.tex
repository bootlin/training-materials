...
cd meta-ti
git checkout -b kirkstone-labs 376a2143533c6497b4e79304eccca2a630784436
...
\code{$BUILDDIR/deploy-ti/images/beagleplay}.
...
\begin{bashinput}
xz -dc $BUILDDIR/deploy-ti/images/beagleplaycore-image-minimal-beagleplay.wic.xz | sudo dd of=/dev/sdX conv=fdatasync bs=4M
\end{bashinput}

...
Run \bashcmd{make DEVICE_TREE=imx93-11x11-frdm} which will build U-Boot
...
Now run again \inlinebash{make DEVICE_TREE=imx93-11x11-frdm}, the build should
end sucessfully. The warning about the missing ./mx93a1-ahab-container.img
can be ignored as we don't implement secure boot.

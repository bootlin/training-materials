...
Extract the latest Buildroot 2022.02.x source again in this directory.
...
\item \code{Toolchain}
  ...
  \item \code{Bootlin toolchain variant}: \code{armv7-eabihf glibc bleeding-edge 2021.11-1}
...
There are definitely infrastructures we don't need in a system as
simple as ours.

...
So, create and enter the \code{$HOME/__SESSION_NAME__-labs/integration}
directory.
...
\item \code{Toolchain}
  ...
  \item \code{Bootlin toolchain variant}: \ifdefstring{\arch}{ARM64}
        {\code{aarch64 glibc bleeding-edge 2025.08-1}}{\code{armv7-eabihf glibc bleeding-edge 2025.08-1}}

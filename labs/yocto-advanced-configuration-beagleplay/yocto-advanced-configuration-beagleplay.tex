...
{\small
\begin{verbatim}
APPEND root=/dev/nfs rw console=${console} nfsroot=192.168.0.1:/nfs,vers=3,tcp ip=192.168.0.100
\end{verbatim}
}
...
\begin{verbatim}
sudo tar xpf $BUILDDIR/deploy-ti/images/beagleplay/\
...
{\small
\begin{verbatim}
setenv bootargs root=/dev/nfs rw console=${console} nfsroot=192.168.0.1:/nfs,vers=3,tcp ip=192.168.0.100
\end{verbatim}
}

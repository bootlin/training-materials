...
$ cp build_kexec/images/zImage /home/$USER/__SESSION_NAME__-labs/nfsroot/root/kexec
$ cp build_kexec/images/stm32mp157a-dk1.dtb /home/$USER/__SESSION_NAME__-labs/nfsroot/root/kexec
\end{bashinput}
...
(We will use 192.168.0.101 to avoid clobbering ssh \code{know_hosts} file for

...
{\scriptsize \sourcecode{labs/kernel-serial-iomem-bbb/uarts-pinctrl.dts}}

Then, declare the corresponding devices:

\sourcecode{labs/kernel-serial-iomem-bbb/uarts.dts}
...
Go to the \code{~/linux-kernel-bbb-labs/modules/nfsroot/root/serial/} directory.
...
\sourcecode{labs/kernel-serial-iomem-bbb/uart-line-init.c}
...
\sourcecode{labs/kernel-serial-iomem-bbb/uart-line-reset.c}

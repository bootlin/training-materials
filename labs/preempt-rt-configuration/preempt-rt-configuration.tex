\subchapter{Lab 3: System partitioning}{}
...
and have it only accessible through \code{taskset}. To do so, you need to change
...
The output should show a maximum latency around 50 000 microseconds. Why is that?

...
{The standard configuration for this kernel is actually \code{omap2plus_defconfig}.}{}
\ifdefstring{\labboard}{beagleplay}
...
So, apply this configuration by running \code{make <config>}, and then run \code{make menuconfig} to fine-tune it.

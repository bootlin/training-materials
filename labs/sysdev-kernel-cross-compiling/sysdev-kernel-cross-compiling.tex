...
Before continuing, we still need to apply a patch to add the device tree for the imx93-frdm in `arch/arm64/boot/dts/freescale` because the board is not yet supported in the kernel.

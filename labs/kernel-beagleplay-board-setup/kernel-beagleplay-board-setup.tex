...
Insert the SD card supplied by your instruction into the board.
...
save your U-Boot environment settings to the SD card.

If you don't have this U-Boot prompt, it's probably because you are doing these labs on your own
(i.e. without participating to a Bootlin course), you'll have to prepare a bootable SD card. Please fetch our precompiled bootloader images from:

\url{https://github.com/bootlin/training-materials/tree/master/embedded-linux-beagleplay/bootloader/data/}

Then follow the instructions from the embedded-linux training labs to prepare the SD card:

\url{https://bootlin.com/doc/training/embedded-linux-beagleplay/embedded-linux-beagleplay-labs.pdf#18}

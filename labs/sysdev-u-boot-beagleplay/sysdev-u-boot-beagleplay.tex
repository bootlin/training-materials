...
Boot and Power/Resource Management requests made by the CPUs inside the SoC.
...
Now create a FAT32 filesystem on the bootable partition:
\begin{bashinput}
...
the environment is already pretty full. This is because the selected

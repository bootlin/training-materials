...
We here aim to extend the \ifdefstring{\board}{stm32mp1}{\code{linux-stm32mp}}
{{\ifdefstring{\board}{beagleplay}{\code{linux-ti-staging}}{\code{linux-bb.org}}}} kernel recipe.
...
\ifdefstring{\board}{stm32mp1}{\code{linux-stm32mp}}
{{\ifdefstring{\board}{beagleplay}{\code{linux-ti-staging}}{\code{linux-bb.org}}}}

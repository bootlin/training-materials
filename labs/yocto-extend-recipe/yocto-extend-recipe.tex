...
We here aim to extend the \linuxrecipename kernel recipe.
...
We want our extended \linuxrecipename kernel to support the Nunchuk as
...
It is handled automatically in the
 \ifdefstring{\board}{beagleplay}{\code{linux-ti-staging}}{\code{linux-bb.org}} original recipe.
\fi

...
\code{mmc0_extlinux/extlinux.conf}, or \code{mmc0_extlinux/stm32mp157c-dk2_extlinux.conf}
file, in the bootfs partition of the SD card and change the \code{APPEND} line
for the \code{stm32mp157a-dk1-sdcard} configuration:

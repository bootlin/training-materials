...
Stay in the \code{~/linux-kernel-imx93-frdm-labs/src/linux} directory,
you should be in the \code{bootlin-labs} branch.
...
But because we do not want to impact the original file, we might instead
...
in the datasheets, let's check the base addresses of these controllers:

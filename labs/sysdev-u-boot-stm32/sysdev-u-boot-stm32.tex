...
fourth partition, which we'll name \code{bootfs}\footnote{Currently, the board's
drivers ignore our choice of which partition to save the uboot.env file. The partition will have to be made bootable for it to work.}.
